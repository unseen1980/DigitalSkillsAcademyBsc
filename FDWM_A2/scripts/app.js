$(document).ready(function() {
    ...
    //     '<li class="hidden-md hidden-lg hidden-xs breadcrumb-mobile-style"><a href="#">football</a></li>' +
    //     '<li class="hidden-md hidden-lg hidden-xs breadcrumb-mobile-style"><a href="#">opinion</a></li>' +
    //     '<li class="hidden-md hidden-lg hidden-xs breadcrumb-mobile-style"><a href="#">culture</a></li>' +
